    ...
    <div className="w-full space-y-6">
      ...
      <div className="grid grid-cols-2 rounded-2xl bg-muted/70 p-1 ring-1 ring-border/50">
        <button
          ...
          className={cn(
            "flex min-h-[44px] touch-manipulation items-center justify-center gap-2 rounded-xl text-xs font-semibold transition-all active:scale-[0.98] sm:text-sm",
            activeTab === "signup"
      ...
      {activeTab === "signup" ? (
        <form onSubmit={handleSignUp} className="space-y-4">
          ...
          <Button
            type="submit"
            className="min-h-[46px] w-full touch-manipulation rounded-xl font-semibold active:scale-[0.98]"
            size="lg"
